...
public final class GroupSql {
    ...
    public static final String FIND_ALL = "SELECT id, name, allow_delete FROM groups ORDER BY name";
    public static final String FIND_BY_ID = "SELECT id, name, allow_delete FROM groups WHERE id = ?";
    public static final String FIND_BY_NAME = "SELECT id, name, allow_delete FROM groups WHERE name = ?";
    ...
    public static final String COUNT_ALL = "SELECT COUNT(*) FROM groups";
}