...
try:
    with tempfile.TemporaryDirectory(prefix='mhl-stage16-') as td:
        ...
        (src/'com/myhomelibcorp/application/export/DeviceProfileService.java').write_text('''package com.myhomelibcorp.application.export; public final class DeviceProfileService { public static final String GENERIC_FOLDER_ID="generic-folder"; private DeviceProfileService(){} }''',encoding='utf-8')
